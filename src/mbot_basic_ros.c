...
static bool enable_pwm_lpf = false;//true;
...
static void mbot_publish_state(void) {
    ...
    encoder_msg.vector.y = mbot_state.encoder_delta_ticks[MOT_R];
    encoder_msg.vector.z = mbot_state.encoder_delta_ticks[MOT_UNUSED];
